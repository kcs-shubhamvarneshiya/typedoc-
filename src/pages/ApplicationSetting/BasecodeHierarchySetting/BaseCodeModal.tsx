...
import { BaseCodeModalProps } from "../../../utils/interfaceModel";

// interface BaseCodeModalProps {
//     isOpen: boolean
//     onClose: VoidFunction
//     formik;
// };

const BaseCodeModal = (props: BaseCodeModalProps) => {
              ...
              <Grid item xs={8}>
                <TextField
                  ...
                  error={
                    ...
                    Boolean(formik.errors.attachType)
                  }
                  onBlur={formik.handleBlur}
                  fullWidth
